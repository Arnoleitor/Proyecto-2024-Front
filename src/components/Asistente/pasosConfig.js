...
const pasos = [
    {
        id: 'intro',
        message: 'Hola soy Paco, ¿cuál es tu nombre?',
      ...
      {
        id: 'mensaje-need-a',
        message: 'Ok, mandamos un ticket a soporte.',
        end: true,
      },
      {
        id: 'mensaje-need-b',
      ...
      {
        id: 'mensaje-need-b3',
        message: 'Ok, si tienes otras dudas, tendrás que enviar un ticket a soporte. Te redirijo...',
        end: true,
      },
